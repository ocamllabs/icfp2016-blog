...
which is at [PLMW](http://conf.researchr.org/track/PLMW-ICFP-2016/PLMW-ICFP-2016)2016 on Sunday 18th 1400-1430 PM.  You can replace all of this text
...
First check GitHub [issue #26](https://github.com/ocamllabs/icfp2016-blog/issue/26) and
...
* copy this template into `icfp2016-blog/PLMW/analyzing-javascript-web-appli/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/PLMW/analyzing-javascript-web-appli)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=PLMW:analyzing-javascript-web-appli).
