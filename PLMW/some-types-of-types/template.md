---
title: PLMW 2016: Some types of types
author: whoami (Anonymous)
abstract: Some types of types
---

This is the template for you to liveblog about the talk,
which is at [PLMW](http://conf.researchr.org/track/PLMW-ICFP-2016/PLMW-ICFP-2016)2016 on Sunday 18th 1130-1215 AM.  You can replace all of this text
...
First check GitHub [issue #14](https://github.com/ocamllabs/icfp2016-blog/issue/14) and
...
* copy this template into `icfp2016-blog/PLMW/some-types-of-types/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/PLMW/some-types-of-types)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=PLMW:some-types-of-types).
