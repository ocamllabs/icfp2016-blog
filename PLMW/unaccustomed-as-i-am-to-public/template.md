---
title: PLMW 2016: Unaccustomed as I am to public speaking
author: whoami (Anonymous)
abstract: Unaccustomed as I am to public speaking
---

This is the template for you to liveblog about the talk,
which is at [PLMW](http://conf.researchr.org/track/PLMW-ICFP-2016/PLMW-ICFP-2016)2016 on Sunday 18th 1730-1800 PM.  You can replace all of this text
...
First check GitHub [issue #39](https://github.com/ocamllabs/icfp2016-blog/issue/39) and
...
* copy this template into `icfp2016-blog/PLMW/unaccustomed-as-i-am-to-public/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/PLMW/unaccustomed-as-i-am-to-public)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=PLMW:unaccustomed-as-i-am-to-public).
