---
title: PLMW 2016: How to write papers so people can read them
author: whoami (Anonymous)
abstract: How to write papers so people can read them
---

This is the template for you to liveblog about the talk,
which is at [PLMW](http://conf.researchr.org/track/PLMW-ICFP-2016/PLMW-ICFP-2016)2016 on Sunday 18th 1600-1630 PM.  You can replace all of this text
...
First check GitHub [issue #33](https://github.com/ocamllabs/icfp2016-blog/issue/33) and
...
* copy this template into `icfp2016-blog/PLMW/how-to-write-papers-so-people-/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/PLMW/how-to-write-papers-so-people-)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=PLMW:how-to-write-papers-so-people-).
