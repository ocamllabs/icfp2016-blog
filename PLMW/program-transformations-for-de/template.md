---
title: PLMW 2016: Program transformations for developing efficient and correct programs with ease
author: whoami (Anonymous)
abstract: Program transformations for developing efficient and correct programs with ease
---

This is the template for you to liveblog about the talk,
which is at [PLMW](http://conf.researchr.org/track/PLMW-ICFP-2016/PLMW-ICFP-2016)2016 on Sunday 18th 1530-1600 PM.  You can replace all of this text
...
First check GitHub [issue #32](https://github.com/ocamllabs/icfp2016-blog/issue/32) and
...
* copy this template into `icfp2016-blog/PLMW/program-transformations-for-de/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/PLMW/program-transformations-for-de)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=PLMW:program-transformations-for-de).
