---
title: OCaml 2016: The state of the OCaml Platform: September 2016
author: whoami (Anonymous)
abstract: The state of the OCaml Platform: September 2016
---

This is the template for you to liveblog about the talk,
which is at [OCaml](http://ocaml.org/meetings/ocaml/2016/)2016 on Friday 23rd 0935-1000 AM.  You can replace all of this text
...
First check GitHub [issue #131](https://github.com/ocamllabs/icfp2016-blog/issue/131) and
...
* copy this template into `icfp2016-blog/OCaml/the-state-of-the-ocaml-platfor/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/OCaml/the-state-of-the-ocaml-platfor)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=OCaml:the-state-of-the-ocaml-platfor).
