---
title: HOPE 2016: Effective programming: bringing algebraic effects and handlers to OCaml
author: whoami (Anonymous)
abstract: Effective programming: bringing algebraic effects and handlers to OCaml
---

This is the template for you to liveblog about the talk,
which is at [HOPE](http://conf.researchr.org/track/icfp-2016/hope-2016-papers)2016 on Sunday 18th 0915-1015 AM.  You can replace all of this text
...
First check GitHub [issue #2](https://github.com/ocamllabs/icfp2016-blog/issue/2) and
...
* copy this template into `icfp2016-blog/HOPE/effective-programming-bringin/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/HOPE/effective-programming-bringin)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=HOPE:effective-programming-bringin).
