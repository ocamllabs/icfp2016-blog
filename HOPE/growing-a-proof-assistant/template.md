---
title: HOPE 2016: Growing a proof assistant
author: whoami (Anonymous)
abstract: Growing a proof assistant
---

This is the template for you to liveblog about the talk,
which is at [HOPE](http://conf.researchr.org/track/icfp-2016/hope-2016-papers)2016 on Sunday 18th 1430-1500 PM.  You can replace all of this text
...
First check GitHub [issue #29](https://github.com/ocamllabs/icfp2016-blog/issue/29) and
...
* copy this template into `icfp2016-blog/HOPE/growing-a-proof-assistant/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/HOPE/growing-a-proof-assistant)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=HOPE:growing-a-proof-assistant).
