---
title: HOPE 2016: Type directed compilation of row-typed algebraic effects
author: whoami (Anonymous)
abstract: Type directed compilation of row-typed algebraic effects
---

This is the template for you to liveblog about the talk,
which is at [HOPE](http://conf.researchr.org/track/icfp-2016/hope-2016-papers)2016 on Sunday 18th 1530-1600 PM.  You can replace all of this text
...
First check GitHub [issue #36](https://github.com/ocamllabs/icfp2016-blog/issue/36) and
...
* copy this template into `icfp2016-blog/HOPE/type-directed-compilation-of-r/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/HOPE/type-directed-compilation-of-r)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=HOPE:type-directed-compilation-of-r).
