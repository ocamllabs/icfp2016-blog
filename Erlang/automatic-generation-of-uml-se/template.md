---
title: Erlang 2016: Automatic generation of UML sequence diagrams from test counterexamples
author: whoami (Anonymous)
abstract: Automatic generation of UML sequence diagrams from test counterexamples
---

This is the template for you to liveblog about the talk,
which is at [Erlang](http://conf.researchr.org/track/icfp-2016/erlang-2016-papers)2016 on Friday 23rd 1520-1545 PM.  You can replace all of this text
...
First check GitHub [issue #158](https://github.com/ocamllabs/icfp2016-blog/issue/158) and
...
* copy this template into `icfp2016-blog/Erlang/automatic-generation-of-uml-se/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/Erlang/automatic-generation-of-uml-se)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=Erlang:automatic-generation-of-uml-se).
