---
title: Scheme 2016: Deriving pure, functional one-pass operations for processing tail-aligned lists
author: whoami (Anonymous)
abstract: Deriving pure, functional one-pass operations for processing tail-aligned lists
---

This is the template for you to liveblog about the talk,
which is at [Scheme](http://scheme2016.snow-fort.org)2016 on Sunday 18th 1600-1630 PM.  You can replace all of this text
...
First check GitHub [issue #31](https://github.com/ocamllabs/icfp2016-blog/issue/31) and
...
* copy this template into `icfp2016-blog/Scheme/deriving-pure-functional-one/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/Scheme/deriving-pure-functional-one)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=Scheme:deriving-pure-functional-one).
