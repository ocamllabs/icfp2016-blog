---
title: Scheme 2016: A multi-purpose web framework design based on websocket over HTTP gateway
author: whoami (Anonymous)
abstract: A multi-purpose web framework design based on websocket over HTTP gateway
---

This is the template for you to liveblog about the talk,
which is at [Scheme](http://scheme2016.snow-fort.org)2016 on Sunday 18th 1730-1800 PM.  You can replace all of this text
...
First check GitHub [issue #43](https://github.com/ocamllabs/icfp2016-blog/issue/43) and
...
* copy this template into `icfp2016-blog/Scheme/a-multipurpose-web-framework-/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/Scheme/a-multipurpose-web-framework-)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=Scheme:a-multipurpose-web-framework-).
