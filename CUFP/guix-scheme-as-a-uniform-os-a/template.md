---
title: CUFP 2016: Guix: Scheme as a uniform OS admin and deployment interface
author: whoami (Anonymous)
abstract: Guix: Scheme as a uniform OS admin and deployment interface
---

This is the template for you to liveblog about the talk,
which is at [CUFP](http://cufp.org/2016/)2016 on Saturday 24th 1545-1610 PM.  You can replace all of this text
...
First check GitHub [issue #197](https://github.com/ocamllabs/icfp2016-blog/issue/197) and
...
* copy this template into `icfp2016-blog/CUFP/guix-scheme-as-a-uniform-os-a/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/CUFP/guix-scheme-as-a-uniform-os-a)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=CUFP:guix-scheme-as-a-uniform-os-a).
