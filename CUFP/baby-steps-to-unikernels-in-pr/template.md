---
title: CUFP 2016: Baby steps to unikernels in production
author: whoami (Anonymous)
abstract: Baby steps to unikernels in production
---

This is the template for you to liveblog about the talk,
which is at [CUFP](http://cufp.org/2016/)2016 on Saturday 24th 1640-1705 PM.  You can replace all of this text
...
First check GitHub [issue #202](https://github.com/ocamllabs/icfp2016-blog/issue/202) and
...
* copy this template into `icfp2016-blog/CUFP/baby-steps-to-unikernels-in-pr/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/CUFP/baby-steps-to-unikernels-in-pr)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=CUFP:baby-steps-to-unikernels-in-pr).
