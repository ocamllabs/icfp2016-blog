---
title: ICFP 2016: Sequent calculus as a compiler intermediate language
author: whoami (Anonymous)
abstract: Sequent calculus as a compiler intermediate language
---

This is the template for you to liveblog about the talk,
which is at [ICFP](http://conf.researchr.org/track/icfp-2016/icfp-2016-papers)2016 on Monday 19th 1405-1430 PM.  You can replace all of this text
...
First check GitHub [issue #51](https://github.com/ocamllabs/icfp2016-blog/issue/51) and
...
* copy this template into `icfp2016-blog/ICFP/sequent-calculus-as-a-compiler/<your-userid>.md` where you can record your notes.
* You can push this file regularly or issue a pull request at your own pace.

If you prefer a web UI:
* navigate [to the GitHub for this talk](https://github.com/ocamllabs/icfp2016-blog/tree/master/ICFP/sequent-calculus-as-a-compiler)
...
Send photos or other social media taken during this talk to [this email](mailto:icfp16.photos@gmail.com?subject=ICFP:sequent-calculus-as-a-compiler).
